...
class HabitatSimInteractiveViewer(Application):
    ...
    def __init__(self, sim_settings: Dict[str, Any]) -> None:
        ...
        relative_path_to_font = "/tmp/habitat-sim/data/fonts/ProggyClean.ttf"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--scene",
        default="/tmp/habitat-sim/data/test_assets/scenes/simple_room.glb",
        type=str,
        help='scene/stage file to load (default: "./data/test_assets/scenes/simple_room.glb")',
    )
    parser.add_argument(
        "--dataset",
        default="/tmp/habitat-sim/data/objects/ycb/ycb.scene_dataset_config.json",
        type=str,
        metavar="DATASET",
